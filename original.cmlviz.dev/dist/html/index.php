			...
			<div class="quote">
				...
				<div class="details">
					...
					<div class="details-navigation">
						...
						<nav class="details-navigation-container-new transformer-tabs" role="navigation">
							...
							<ul>
								...
								<li>
									...
									<a href="#risk-chart">Risk Chart</a>
								...
								<li>
									...
									<a href="#option-back-tester">Option Back-Tester</a>
					...
					<div class="details-content">
						...
						<div class="panels">
							...
							<?php include 'inc/stock-chart.php'; ?>

							<?php include 'inc/risk-chart.php'; ?>

							<?php include 'inc/financials.php'; ?>

							<?php include 'inc/financial-charts.php'; ?>

							<?php include 'inc/holders.php'; ?>

							<?php include 'inc/analysts.php'; ?>

							<?php include 'inc/option-back-tester.php'; ?>
